...
public final class ActivityEducationBinding implements ViewBinding {
  ...
  private ActivityEducationBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView10,
  ...
  public static ActivityEducationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEducationBinding((ConstraintLayout) rootView, textView10, textView11,
