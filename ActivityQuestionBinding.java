...
public final class ActivityQuestionBinding implements ViewBinding {
  ...
  private ActivityQuestionBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView10,
  ...
  public static ActivityQuestionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityQuestionBinding((ConstraintLayout) rootView, textView10, textView11,
